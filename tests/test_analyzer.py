...
class TestAnalyzer(unittest.TestCase):
    ...
    @patch("systemmanager_sagehelper.analyzer._resolve_reverse_dns", return_value="srv-10.domain.local")
    @patch("systemmanager_sagehelper.analyzer._ermittle_ip_adressen", side_effect=[["10.0.2.10"], ["10.0.2.11"]])
    @patch("systemmanager_sagehelper.analyzer.pruefe_tcp_port", return_value=True)
    @patch("systemmanager_sagehelper.analyzer._ermittle_socket_kandidaten", return_value=[object()])
    @patch("systemmanager_sagehelper.analyzer._ping_host", return_value=True)
    def test_discovery_range_ips_im_selben_netz_werden_nicht_kollabiert(
        self,
        _ping_mock,
        _sock_mock,
        _port_mock,
        ...
        self.assertEqual(2, len(ergebnisse))
        self.assertEqual(["10.0.2.10", "10.0.2.11"], sorted(e.ip_adresse for e in ergebnisse))
